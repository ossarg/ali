...
// Claim represents a SISE siniestro persisted in our DB for analytics and case linkage.
type Claim struct {
	...
	ClaimSubnumber    int64 `gorm:"not null;default:1"   json:"claim_subnumber"`
	...
	EstimatedAmount  float64    `gorm:"type:numeric(15,2);default:0" json:"estimated_amount"`
