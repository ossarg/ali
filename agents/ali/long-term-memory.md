...
- [trust:1.0|src:observed|used:2026-03-25|hits:8] ✅ Script backup DB restaurado desde 2026-03-16. Backups 14/03 y 15/03 perdidos (20 bytes vacíos). Racha actual: 16→25/03 (diez días consecutivos, 223→228KB). Último backup válido anterior al fallo: libra_legal_20260313_0300.sql.gz (227618 bytes).
...
- [trust:1.0|src:direct|used:2026-03-25|hits:12] Branch `sesion/2025-12-23`: 13 skills + ORCHESTRATION.md mergeados. PR aún no abierto. Branch activa secundaria.
...
- [trust:1.0|src:observed|used:2026-03-25|hits:22] Actividad sin sesión humana con Ali: miércoles, jueves, fines de semana y viernes exclusivamente Woz/Nacho. Ali solo corre en crons. (Excepción: 25/03 miércoles con sesión humana activa — trabajo en Jess/drafting-answer-ar.)
- [trust:1.0|src:direct|used:2026-03-25|hits:12] Model routing: Opus → planeamiento/complejo; Sonnet → ejecución/diario; Haiku → heartbeats/sencillos.
- [trust:1.0|src:direct|used:2026-03-25|hits:12] Pipeline: Rachel → Donna (Ingestion) → Mike (Extraction) → Edu (Triage x3) → Jess (Drafting) → Review (Red Team) → Abogado.
- [trust:1.0|src:direct|used:2026-03-25|hits:12] Canal #litigios = ID 1478558938352844891. Mensajes de Juan no llegan a Ali — pendiente debug.
