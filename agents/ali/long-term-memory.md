...
- [trust:1.0|src:observed|used:2026-03-19|hits:2] ✅ Script backup DB restaurado desde 2026-03-16. Backups 14/03 y 15/03 perdidos (20 bytes vacíos). Racha actual: 16, 17, 18, 19/03 (cuatro días consecutivos ~228KB). Último backup válido anterior al fallo: libra_legal_20260313_0300.sql.gz (227618 bytes).
...
- [trust:1.0|src:direct|used:2026-03-19|hits:6] Branch `sesion/2025-12-23`: 13 skills + ORCHESTRATION.md mergeados. PR aún no abierto. Branch activa secundaria.
...
- [trust:1.0|src:observed|used:2026-03-19|hits:16] Actividad sin sesión humana con Ali: miércoles, jueves, fines de semana y viernes exclusivamente Woz/Nacho. Ali solo corre en crons.
- [trust:1.0|src:direct|used:2026-03-19|hits:6] Model routing: Opus → planeamiento/complejo; Sonnet → ejecución/diario; Haiku → heartbeats/sencillos.
- [trust:1.0|src:direct|used:2026-03-19|hits:6] Pipeline: Rachel → Donna (Ingestion) → Mike (Extraction) → Edu (Triage x3) → Jess (Drafting) → Review (Red Team) → Abogado.
- [trust:1.0|src:direct|used:2026-03-19|hits:6] Canal #litigios = ID 1478558938352844891. Mensajes de Juan no llegan a Ali — pendiente debug.
...
- [trust:1.0|src:observed|used:2026-03-19|hits:2] development tiene commits que AÚN NO están en main: c654fb4 (DeepAgents analysis), 53387fa (Woz specs), c9e2624 (Edu/Jess prompts), 7fe615f (orchestration-pipeline-runner skill), 89dc08f (Lou como agente first-class + pipeline-canon.md), 950f604 (canonical naming). Pendiente nuevo PR development → main.
