...
- [trust:1.0|src:observed|used:2026-03-17|hits:1] ✅ Script backup DB restaurado desde 2026-03-16. Backups 14/03 y 15/03 perdidos (20 bytes vacíos). Último backup válido antes del fallo: libra_legal_20260313_0300.sql.gz (227618 bytes).
...
- [trust:1.0|src:direct|used:2026-03-17|hits:5] Branch `sesion/2025-12-23`: 13 skills + ORCHESTRATION.md mergeados. PR aún no abierto. Branch activa secundaria.
...
- [trust:1.0|src:observed|used:2026-03-17|hits:14] Actividad sin sesión humana con Ali: fines de semana y viernes exclusivamente Woz/Nacho. Ali solo corre en crons.
- [trust:1.0|src:direct|used:2026-03-17|hits:5] Model routing: Opus → planeamiento/complejo; Sonnet → ejecución/diario; Haiku → heartbeats/sencillos.
- [trust:1.0|src:direct|used:2026-03-17|hits:5] Pipeline: Rachel → Donna (Ingestion) → Mike (Extraction) → Edu (Triage x3) → Jess (Drafting) → Review (Red Team) → Abogado.
- [trust:1.0|src:direct|used:2026-03-17|hits:5] Canal #litigios = ID 1478558938352844891. Mensajes de Juan no llegan a Ali — pendiente debug.
...
- [trust:1.0|src:observed|used:2026-03-17|hits:1] development tiene commits de Ali que AÚN NO están en main: c654fb4 (DeepAgents analysis), 53387fa (Woz specs), c9e2624 (Edu/Jess prompts), y el skill orchestration-pipeline-runner. Pendiente nuevo PR development → main.
