...
export const CaseEventSchema = z.object({
  ...
  mail_id: z.string(),
  mail_provider: z.string().nullish(),
  ...
  raw_claim_number: z.string().nullish(),
  raw_policy: z.string().nullish(),
  raw_case_number: z.string().nullish(),
  raw_caratula: z.string().nullish(),
  processed: z.boolean().optional(),
  received_at: z.string(),
  created_at: z.string(),
  approved: z.boolean().nullish(),
  original_mail_type: z.string().nullish(),
  case_title: z.string().nullish(),
  case_caratula: z.string().nullish(),
  reviewed_by: z.string().nullish(),
  reviewed_at: z.string().nullish(),
  reviewed_by_name: z.string().nullish(),
  review_comment: z.string().nullish(),
  body_clean: z.string().nullish(),
  ...
  resolution_error: z.string().nullish(),
  resolved_claim_id: z.string().nullish(),
  corrected_claim_number: z.string().nullish(),
  correction_comment: z.string().nullish(),
});
